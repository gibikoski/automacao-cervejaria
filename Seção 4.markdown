...
**Legenda do Diagrama** 📋:
- 🔴 Alimentação (VCC, VOUT, VIN).
- ⚫ Terra (GND, AD0, INT, INT1).
- ⚪ Clock I2C (SCL).
- 🟡 Dados I2C/Serial/1-wire (SDA, DQ, GPIO2).
- 🔵 Digital/UART/Serial (D2, D3, PD0, PD1, I2C, Saída).
...
- **Ajustes Realizados**:
  ...
  - Diagramas atualizados:
    - Rótulos com hífen (ex.: `VCC-P16-5V`) em vez de vírgula.
    - Emojis movidos para legenda no Markdown (🔴, ⚫, ⚪, 🟡, 🔵).
  - Tabelas mantidas:
...
- **Validação**: Confirme a Visão Geral, diagramas (rótulos com hífen, ex.: `VCC-P16-5V`), legendas (emojis 🔴, ⚫, ⚪, 🟡, 🔵), tabelas (ESP8266 sem pinos flutuantes), pinouts, e endereços I2C. Indique ajustes (ex.: rótulos, emojis, pinos).
