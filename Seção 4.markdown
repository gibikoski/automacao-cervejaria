...
- **Ajustes Realizados**:
  - Visão Geral reformulada (mais concisa, sem componentes passivos, funções, ou protocolos).
  - Diagramas corrigidos (sintaxe de conexões I2C, bidirecionalidade removida).
