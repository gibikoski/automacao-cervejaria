...
**Legenda do Diagrama** 📋:
- 🔴 Alimentação (VCC, VOUT, VIN) - <span style="color:red">Vermelho</span>.
- ⚫ Terra (GND, AD0, INT, INT1) - <span style="color:black">Preto</span>.
- ⚪ Clock I2C (SCL) - <span style="color:white;background-color:gray">Branco</span>.
- 🟡 Dados I2C/Serial/1-wire (SDA, DQ, GPIO2) - <span style="color:yellow">Amarelo</span>.
- 🔵 Digital/UART/Serial (D2, D3, PD0, PD1, I2C, Saída) - <span style="color:blue">Azul</span>.
...
- **Ajustes Realizados**:
  ...
  - Diagramas mantidos:
    - Rótulos com hífen (ex.: `VCC-P16-5V`) no formato `<sinal>-<pino (De)>-<protocolo>`.
    - Sem identificadores, estilos, ou tema `dark`.
  - Legendas atualizadas:
    - Palavras coloridas via HTML inline (ex.: `<span style="color:red">Vermelho</span>`).
    - Emojis mantidos (🔴, ⚫, ⚪, 🟡, 🔵).
  - Tabelas mantidas:
...
- **Validação**: Confirme a Visão Geral, diagramas (rótulos com hífen, ex.: `VCC-P16-5V`), legendas (emojis 🔴, ⚫, ⚪, 🟡, 🔵; palavras coloridas como `<span style="color:red">Vermelho</span>`), tabelas (ESP8266 sem pinos flutuantes), pinouts, e endereços I2C. Indique ajustes (ex.: rótulos, emojis, cores, pinos).
