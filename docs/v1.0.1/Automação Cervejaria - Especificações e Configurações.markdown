...
| Capacitores (0,1 µF, 1 µF) | Vários | - | 9,50 | A comprar (Mês 4) |
...
| RP3 | Enviar dados de volume via MQTT. | Primário | *Plano de Execução*, Seção 4.2, T3.1 |
...
| RD3.2 | Biblioteca PubSubClient. | Derivado | *Plano de Execução*, Seção 4.4, T1.1 |
