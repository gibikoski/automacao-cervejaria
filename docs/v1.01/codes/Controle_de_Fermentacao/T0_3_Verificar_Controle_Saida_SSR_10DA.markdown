# T0_3_Verificar_Controle_Saida_SSR_10DA  
...
- **Código Associado**: [T0_3_Verificar_Controle_Saida_SSR_10DA.ino](./T0_3_Verificar_Controle_Saida_SSR_10DA.ino)  
- **Diretório**: docs/V1.01/codes/Controle_de_Fermentacao/T0_3  

## Descrição  
Este teste verifica o controle de saída do relé SSR-10DA conectado ao Arduino R4 Connect, alternando o estado (LIGADO/DESLIGADO) e exibindo o status no Serial Monitor.  
...
- O Serial Monitor exibe:  
  - "Teste T0.3 - Controle Saída SSR-10DA Iniciado".  
  - Alternadamente, a cada 2 segundos:  
    - "Relé SSR-10DA: LIGADO".  
    - "Relé SSR-10DA: DESLIGADO".  
- Se uma carga estiver conectada, ela deve ligar/desligar sincronizada com as mensagens.  

## Notas  
- Caso o relé não alterne, verificar conexões, alimentação do relé e integridade do SSR-10DA.  
- Este teste valida o requisito RD4.2 (controle de saída confiável).  
- Para segurança, desconectar a carga de alta tensão antes de manipular o circuito.  
