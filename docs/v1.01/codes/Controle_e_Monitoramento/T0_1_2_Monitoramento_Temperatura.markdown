# T0_1_2_Monitoramento_Temperatura  
...
- **Código Associado**: [T0_1_2_Monitoramento_Temperatura.ino](./T0_1_2_Monitoramento_Temperatura.ino)  
- **Diretório**: docs/V1.01/codes/Controle_e_Monitoramento/T0_1_2  

## Descrição  
Este teste monitora a temperatura ambiente usando o sensor DHT22, exibindo os valores no LCD 16x2 e no Serial Monitor a cada segundo.  
...
- LCD exibe:  
  - Linha 1: "Monitor Temp".  
  - Linha 2: "Temp: [valor] C" (ex.: Temp: 25.0 C), atualizado a cada 1 segundo.  
  - Se falhar: "Erro DHT22!" ou "Erro Leitura!".  
- Serial Monitor exibe:  
  - "Teste T0.1.2 - Monitoramento Temperatura Iniciado".  
  - A cada 1 segundo: "Temperatura: [valor] °C".  
  - Se falhar: "Erro: Falha na leitura do DHT22!".  

## Notas  
- Verificar conexões do DHT22 para evitar leituras inválidas.  
- Ajustar contraste do LCD para visibilidade.  
- Valida o requisito RC1.2 (monitoramento de temperatura).  
