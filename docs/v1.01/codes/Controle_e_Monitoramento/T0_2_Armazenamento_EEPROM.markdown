...
- **Código Associado**: [T0_2_Armazenamento_EEPROM.ino](./T0_2_Armazenamento_EEPROM.ino)  
- **Diretório**: docs/V1.01/codes/Controle_e_Monitoramento/T0_2  

## Descrição  
Este teste armazena temperaturas medidas pelo DHT22 na EEPROM do Arduino, permitindo até 100 registros, com exibição no Serial Monitor.  

## Setup  
- Conectar o Arduino R4 Connect via USB ou fonte 7-12V.  
- Conectar o sensor DHT22:  
  - Dados ao pino 8, VCC ao 3.3V, GND ao GND.  
- Instalar bibliotecas `DHT` e `EEPROM`.  
- Carregar o sketch e abrir o Serial Monitor (9600 baud).  

## Resultados Esperados  
- Serial Monitor exibe:  
  - "Teste T0.2 - Armazenamento EEPROM Iniciado".  
  - A cada 2 segundos:  
    - "Temperatura: [valor] °C".  
    - "Temperatura armazenada: [valor] °C, Registro #[número]".  
  - Após 100 registros: "EEPROM cheia!".  
  - Se falhar: "Erro: Falha na leitura do DHT22!".  

## Notas  
- Limite de 100 registros para evitar overflow na EEPROM.  
- Para ler dados armazenados, um código adicional pode ser implementado.  
- Valida o requisito RC2.1 (armazenamento de dados).  
