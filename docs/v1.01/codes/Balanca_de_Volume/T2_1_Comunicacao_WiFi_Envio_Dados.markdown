# T2_1_Comunicacao_WiFi_Envio_Dados  
...
- **Código Associado**: [T2_1_Comunicacao_WiFi_Envio_Dados.ino](./T2_1_Comunicacao_WiFi_Envio_Dados.ino)  
- **Diretório**: docs/V1.01/codes/Balanca_de_Volume/T2_1  

## Descrição  
Este teste envia peso e volume medidos pelo HX711 via WiFi, simulando o envio e exibindo status no Serial Monitor.  
...
- Garantir alcance de uma rede WiFi funcional.  

## Resultados Esperados  
- Serial Monitor exibe:  
  - "Teste T2.1 - Comunicação WiFi Envio Dados Iniciado".  
...
- Valida o requisito RD4.1 (comunicação WiFi).  
