...
- **Código Associado**: [T0_1_1_Inicializar_HX711.ino](./T0_1_1_Inicializar_HX711.ino)  
- **Diretório**: docs/V1.01/codes/Balanca_de_Volume/T0_1_1  

## Descrição  
Este teste verifica a inicialização do sensor HX711, confirmando a comunicação com o Arduino R4 Connect e exibindo o status no Serial Monitor.  
...
- Serial Monitor exibe:  
  - "Teste T0.1.1 - Inicialização HX711 Iniciado".  
  - "HX711 inicializado com sucesso." (se OK).  
  - Ou "Erro: Falha ao inicializar o HX711!" (se falhar).  

## Notas  
- Se falhar, verificar conexões e alimentação do HX711.  
