...
- **Código Associado**: [T1_2_Integrar_Botao_Tara.ino](./T1_2_Integrar_Botao_Tara.ino)  
- **Diretório**: docs/V1.01/codes/Balanca_de_Volume/T1_2  

## Descrição  
Este teste integra um botão para realizar tara no sensor HX711, exibindo peso (g) e volume (L) no Serial Monitor.  
...
- Instalar a biblioteca `HX711`.  
- Carregar o sketch e abrir o Serial Monitor (9600 baud).  
- Calibrar previamente o HX711 (ver T0.1.3).  

## Resultados Esperados  
- Serial Monitor exibe:  
  - "Teste T1.2 - Integração Botão Tara Iniciado".  
  - A cada 0.5 segundos: "Peso: [valor] g | Volume: [valor/1000] L".  
  - Ao pressionar o botão: "Tara realizada.", e o peso zera.  

## Notas  
- Botão usa pull-up interno; pressionar conecta ao GND.  
- Se a tara não funcionar, verificar conexões do botão.  
- Valida o requisito RD3.2 (interação com usuário).  
