...
- **Código Associado**: [T0_2_Converter_Peso_Volume.ino](./T0_2_Converter_Peso_Volume.ino)  
- **Diretório**: docs/V1.01/codes/Balanca_de_Volume/T0_2  

## Descrição  
Este teste converte o peso medido pelo HX711 em volume (litros), assumindo densidade da água (1 g/ml), exibindo ambos no Serial Monitor.  
...
- Serial Monitor exibe:  
  - "Teste T0.2 - Conversão Peso para Volume Iniciado".  
  - A cada 1 segundo: "Peso: [valor] g | Volume: [valor/1000] L" (ex.: Peso: 1000 g | Volume: 1.0 L).  

## Notas  
- Assumes densidade da água (1 g/ml); ajustar para outros líquidos se necessário.  
- Se leituras forem imprecisas, verificar calibração e célula de carga.  
- Valida o requisito RD2.1 (conversão de peso para volume).  
