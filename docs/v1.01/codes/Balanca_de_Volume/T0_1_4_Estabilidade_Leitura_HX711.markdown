# T0_1_4_Estabilidade_Leitura_HX711  
...
- **Código Associado**: [T0_1_4_Estabilidade_Leitura_HX711.ino](./T0_1_4_Estabilidade_Leitura_HX711.ino)  
- **Diretório**: docs/V1.01/codes/Balanca_de_Volume/T0_1_4  

## Descrição  
Este teste avalia a estabilidade da leitura do HX711, calculando o peso médio e o desvio padrão de 10 leituras, exibindo no Serial Monitor.  
...
- Calibrar previamente o HX711 (ver T0.1.3) ou usar fator de escala temporário.  

## Resultados Esperados  
- Serial Monitor exibe:  
  - "Teste T0.1.4 - Estabilidade Leitura HX711 Iniciado".  
  - A cada 2 segundos: "Peso médio: [valor] g | Desvio padrão: [valor] g".  
  - Desvio padrão deve ser baixo (ex.: < 0.5 g) para leituras estáveis.  

## Notas  
- Desvio alto indica instabilidade; verificar célula de carga e conexões.  
