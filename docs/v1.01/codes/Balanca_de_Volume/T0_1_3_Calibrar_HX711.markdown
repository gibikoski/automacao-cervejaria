...
- **Código Associado**: [T0_1_3_Calibrar_HX711.ino](./T0_1_3_Calibrar_HX711.ino)  
- **Diretório**: docs/V1.01/codes/Balanca_de_Volume/T0_1_3  

## Descrição  
Este teste realiza a calibração do sensor HX711, permitindo tara e ajuste com peso conhecido, exibindo o peso em gramas no Serial Monitor.  
...
- Preparar um peso conhecido (ex.: 100g).  

## Resultados Esperados  
- Serial Monitor exibe:  
  - "Teste T0.1.3 - Calibração HX711 Iniciado".  
  - "Coloque um peso conhecido e pressione qualquer tecla para tarar...".  
  - Após tecla: "Tara realizada. Digite o peso conhecido (em gramas):".  
  - Após inserir peso: "Calibração concluída.".  
  - A cada 1 segundo: "Peso: [valor] g" (ex.: 100.5 g).  
- Se falhar: "Erro: HX711 não está pronto!".  

## Notas  
- Usar peso conhecido preciso para calibração.  
- Se as leituras forem instáveis, verificar conexões e célula de carga.  
- Valida o requisito RD1.3 (calibração de sensor).  
