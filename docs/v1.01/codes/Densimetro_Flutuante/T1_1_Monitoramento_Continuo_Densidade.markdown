# T1_1_Monitoramento_Continuo_Densidade  
...
- **Código Associado**: [T1_1_Monitoramento_Continuo_Densidade.ino](./T1_1_Monitoramento_Continuo_Densidade.ino)  
- **Diretório**: docs/V1.01/codes/Densimetro_Flutuante/T1_1  

## Descrição  
Este teste monitora continuamente a densidade do líquido com base na posição do densímetro flutuante, exibindo os valores no LCD 16x2 e no Serial Monitor, com opção de recalibração via botão.  
...
- Serial Monitor exibe:  
  - "Teste T1.1 - Monitoramento Contínuo Densidade Iniciado".  
...
- Verificar estabilidade do densímetro para leituras consistentes.  
- Valida o requisito RD3.1 (monitoramento contínuo).  
