...
- **Código Associado**: [T0_1_2_Leitura_Posicao_Bruta.ino](./T0_1_2_Leitura_Posicao_Bruta.ino)  
- **Diretório**: docs/V1.01/codes/Densimetro_Flutuante/T0_1_2  

## Descrição  
Este teste verifica a leitura de dados brutos de posição (distância em mm) do sensor VL53L0X, exibindo os valores no Serial Monitor a cada 1 segundo.  
...
- Posicionar o sensor voltado para uma superfície a até 2 metros.  

## Resultados Esperados  
- Serial Monitor exibe:  
  - "Teste T0.1.2 - Leitura Posição Bruta Iniciado".  
  - A cada 1 segundo: "Distância: [valor] mm" (ex.: 500 mm).  
  - Se falhar: "Erro: Timeout na leitura do VL53L0X!".  

## Notas  
- Valores variam conforme a distância da superfície refletora.  
- Se ocorrer timeout, verificar alinhamento do sensor e iluminação ambiente.  
