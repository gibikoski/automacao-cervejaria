# T4_2_Validacao_Liquidos_Densidade_Conhecida  
...
- **Código Associado**: [T4_2_Validacao_Liquidos_Densidade_Conhecida.ino](./T4_2_Validacao_Liquidos_Densidade_Conhecida.ino)  
- **Diretório**: docs/V1.01/codes/Densimetro_Flutuante/T4_2  

## Descrição  
Este teste valida a precisão do densímetro flutuante usando líquidos de densidade conhecida (água: 1000 kg/m³, etanol: 789 kg/m³), exibindo resultados e erro percentual no LCD e Serial Monitor.  
...
- Instalar bibliotecas `Adafruit_VL53L0X` e `LiquidCrystal`.  
- Carregar o sketch e abrir o Serial Monitor (9600 baud).  
- Posicionar o densímetro flutuante em líquidos de densidade conhecida (água, depois etanol).  

## Resultados Esperados  
- LCD exibe:  
  - Linha 1: "Densimetro".  
  - Linha 2: "[Líquido]:[valor] kg/m3" (ex.: Agua:1000), atualizado a cada 1 segundo.  
  - Se falhar: "Erro Sensor!" ou "Erro Leitura!".  
- Serial Monitor exibe:  
  - "Teste T4.2 - Validação Líquidos Densidade Conhecida Iniciado".  
  ...
  - A cada 1 segundo:  
    - "Líquido: [nome] | Densidade: [valor] kg/m³ | Erro: [valor]%".  
  - Ao pressionar o botão: "Recalibração concluída. Novo offset: [valor] mm".  
  - Ao enviar qualquer tecla pelo Serial Monitor: "Trocado para: [novo líquido]".  
  - Se falhar: "Erro: Timeout na leitura!".  
- Erro esperado: < 5% para líquidos conhecidos.  

## Notas  
- Trocar líquidos com cuidado, limpando o densímetro.  
- Ajustar `KNOWN_DENSITIES` e `LIQUIDS` para outros líquidos, se necessário.  
- Valida o requisito RD6.2 (validação de precisão).  
