# T0_1_4_Estabilidade_Leitura_Posicao  
...
- **Código Associado**: [T0_1_4_Estabilidade_Leitura_Posicao.ino](./T0_1_4_Estabilidade_Leitura_Posicao.ino)  
- **Diretório**: docs/V1.01/codes/Densimetro_Flutuante/T0_1_4  

## Descrição  
Este teste avalia a estabilidade da leitura de posição do sensor VL53L0X, calculando a distância média e o desvio padrão de 10 leituras, exibindo no Serial Monitor.  
...
- Posicionar o sensor voltado para uma superfície fixa a até 2 metros.  

## Resultados Esperados  
- Serial Monitor exibe:  
  - "Teste T0.1.4 - Estabilidade Leitura Posição Iniciado".  
  - A cada 2 segundos: "Distância média: [valor] mm | Desvio padrão: [valor] mm".  
  - Desvio padrão deve ser baixo (ex.: < 5 mm) para leituras estáveis.  

## Notas  
- Desvio alto indica instabilidade; verificar alinhamento, superfície refletora e iluminação.  
- Valida o requisito RD1.4 (estabilidade de leitura).  
