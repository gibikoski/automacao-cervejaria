# T0_4_Integrar_Botao_Recalibracao  
...
- **Código Associado**: [T0_4_Integrar_Botao_Recalibracao.ino](./T0_4_Integrar_Botao_Recalibracao.ino)  
- **Diretório**: docs/V1.01/codes/Densimetro_Flutuante/T0_4  

## Descrição  
Este teste integra um botão para recalibrar a posição de referência do sensor VL53L0X, permitindo ajustes manuais durante a operação, com densidade exibida no Serial Monitor.  
...
- Serial Monitor exibe:  
  - "Teste T0.4 - Integração Botão Recalibração Iniciado".  
...
## Notas  
- Botão usa pull-up interno; pressionar conecta ao GND.  
- Verificar estabilidade do densímetro após recalibração.  
- Valida o requisito RD2.3 (interação com usuário).  
