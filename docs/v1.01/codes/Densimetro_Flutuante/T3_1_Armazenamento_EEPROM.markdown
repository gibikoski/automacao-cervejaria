...
- **Código Associado**: [T3_1_Armazenamento_EEPROM.ino](./T3_1_Armazenamento_EEPROM.ino)  
- **Diretório**: docs/V1.01/codes/Densimetro_Flutuante/T3_1  

## Descrição  
Este teste armazena densidades medidas na EEPROM do Arduino, permitindo até 100 registros, com exibição no Serial Monitor e recalibração via botão.  
...
- Instalar bibliotecas `Adafruit_VL53L0X` e `EEPROM`.  
...
- Serial Monitor exibe:  
  - "Teste T3.1 - Armazenamento EEPROM Iniciado".  
...
- Valida o requisito RD5.1 (armazenamento de dados).  
