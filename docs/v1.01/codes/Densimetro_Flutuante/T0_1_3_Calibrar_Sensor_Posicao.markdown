# T0_1_3_Calibrar_Sensor_Posicao  
...
- **Código Associado**: [T0_1_3_Calibrar_Sensor_Posicao.ino](./T0_1_3_Calibrar_Sensor_Posicao.ino)  
- **Diretório**: docs/V1.01/codes/Densimetro_Flutuante/T0_1_3  

## Descrição  
Este teste realiza a calibração do sensor VL53L0X, definindo uma posição de referência (zero) e exibindo distâncias calibradas no Serial Monitor.  
...
- Preparar o densímetro flutuante na posição de referência (ex.: base do recipiente).  

## Resultados Esperados  
- Serial Monitor exibe:  
  - "Teste T0.1.3 - Calibração Sensor Posição Iniciado".  
  ...
  - A cada 1 segundo: "Distância calibrada: [valor] mm" (ex.: 0 mm na referência).  
  - Se falhar: "Erro: Timeout na leitura!".  

## Notas  
- A posição de referência deve ser estável durante a calibração.  
- Se as leituras forem instáveis, verificar alinhamento e iluminação.  
