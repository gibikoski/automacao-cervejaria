...
- **Código Associado**: [T0_3_Integrar_Display_LCD.ino](./T0_3_Integrar_Display_LCD.ino)  
- **Diretório**: docs/V1.01/codes/Densimetro_Flutuante/T0_3  

## Descrição  
Este teste integra o sensor VL53L0X com um display LCD 16x2, exibindo a densidade calculada com base na posição do densímetro flutuante.  
...
- LCD exibe:  
  - Linha 1: "Densimetro".  
  - Linha 2: "Dens: [valor] kg/m3" (ex.: Dens: 1000 kg/m3).  
  - Se falhar: "Erro Sensor!" ou "Erro Leitura!".  
- Serial Monitor exibe:  
  - "Teste T0.3 - Integração Display LCD Iniciado".  
  ...
  - A cada 1 segundo: "Densidade: [valor] kg/m³".  
  - Se falhar: "Erro: Timeout na leitura!".  

## Notas  
- Ajustar contraste do LCD para visibilidade.  
- Verificar conexões do sensor e LCD se houver falhas.  
- Valida o requisito RD2.2 (integração com display).  
